...
import { APIRoute, TIMEOUT_SHOW_ERROR } from '../const/routes';
...
const clearErrorAction = createAsyncThunk('offers/clearError', () => {
...
>('data/fetchOffer', async (_arg, { dispatch, extra: api }) => {
